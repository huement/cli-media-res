...
//!DESC Godess2x-v3.2-Darken-DoG-(HQ)-Difference-X
//!HOOK MAIN
//!BIND HOOKED
//!BIND LINELUMA
//!SAVE LINEKERNEL
...
//!DESC Godess2x-v3.2-Darken-DoG-(HQ)-Difference-Y
//!HOOK MAIN
//!BIND HOOKED
//!BIND LINELUMA
//!BIND LINEKERNEL
...
//!DESC Godess2x-v3.2-Darken-DoG-(HQ)-Gaussian-X
//!HOOK MAIN
//!BIND HOOKED
//!BIND LINEKERNEL
//!SAVE LINEKERNEL
...
//!DESC Godess2x-v3.2-Darken-DoG-(HQ)-Gaussian-Y
//!HOOK MAIN
//!BIND HOOKED
//!BIND LINEKERNEL
