...
[![Command](https://img.shields.io/badge/command-pywocky-00E5FF.svg?logo=gnumetacharacters&logoColor=white)](#-repository-architecture)
...
[![Hardware Accel](https://img.shields.io/badge/GPU_Accelerated-Apple_AMD_NVIDIA-success.svg?logo=ffmpeg&logoColor=white)](https://ffmpeg.org/)
[![Tools](https://img.shields.io/badge/Tools-VIDS_GIFS_CODEIMGS_AUDIO-orange.svg?logo=gnumetacharacters&logoColor=white)](#-summary-of-included-tools)
...
_(Note: If using standard virtual environments instead of pipx, run pip install -e ".[all]" inside your active venv.)_
...
The pywocky command has a number of tools and actions that it can use. While you can run each of the scripts manually, the pywocky command provides a responsive TUI that makes using them a breeze. Instantly add in options and configure flags via a helpful interface.
